function [tot_Loss_R,tot_Loss_N,tot_Loss_F,maxtempRear,maxtempfront,maxtempwing,maxtempbat,tot_loss_bat]= Heating()
...
Tambient = 30;
TR_initial = 30; % Initial rear cablestemperature (degC)
TF_initial = 30;
TN_initial = 30;
...
for i =2:2100
    ...
    Tbat(i) = Tbat(i-1) + (1/(BatteryMass*Cbat))*(((totcurrent(i)^2)*intres * dt) + K*A*(TR_initial-Tbat(i-1))*(1/L) );
    ...
    outlet_temp(i) = ((TR_initial + Tbat(i-1))/2) - (K*A*(TR_initial-Tbat(i-1)))*(1/(L*0.333*4200));
